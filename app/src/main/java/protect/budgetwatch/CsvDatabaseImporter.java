...
public class CsvDatabaseImporter implements DatabaseImporter
{
            ...
            throws FormatException
    {
        ...
        String premium = extractString(DBHelper.TransactionDbIds.PREMIUM, record, "");
        String budget = extractString(DBHelper.TransactionDbIds.BUDGET, record, "");
        double commission = extractDouble(DBHelper.TransactionDbIds.COMMISSION, record);
            ...
            throws FormatException
    {
        ...
        int budget = extractInt(DBHelper.TransactionDbIds.COMMISSION, record);
